...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    private long autoGeneratedTimestamp = UNSET_AUTO_GENERATED_TIMESTAMP;  // 取得当前时间

    private boolean isRetry = false;
    private long ifSeqNo = UNASSIGNED_SEQ_NO;  // bulk写入过来的时候，默认也为-2
    private long ifPrimaryTerm = UNASSIGNED_PRIMARY_TERM;  // 默认为0
